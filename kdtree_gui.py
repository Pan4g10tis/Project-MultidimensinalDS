...
class KDTreeGUI:
    ...
    def perform_search(self):
        ...
        # Call the KD-tree main function with selected attributes and conditions
        results = kdtree_main(self.selected_attributes, self.conditions)
        print("Results from kdtree_main:", results)  # Debug print
